...
public class supprimerfilm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Suppresion Film");
...
// TODO add your handling code here:
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       String idfilm=this.jTextField5.getText();
        ...
        String requette1="delete from ticket where idfilm= "+idfilm; 
        try {
        ...
        String requette="delete from film where idfilm= "+idfilm; 
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection connection=DriverManager.getConnection("jdbc:mysql://localhost:3306/gestion","root","admin");
            Statement St= connection.createStatement();
            St.executeUpdate(requette);
            JOptionPane.showMessageDialog(this," film supprimé avec succées !!");
        }
        catch(Exception e){
            System.out.println(e.toString());
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                supprimerfilm s = new supprimerfilm();
                s.setVisible(true);
