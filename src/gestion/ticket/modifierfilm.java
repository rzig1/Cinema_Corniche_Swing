 ...
 * @author MSI
 */
public class modifierfilm extends javax.swing.JFrame {

    /**
     * Creates new form modifierfilm
     */
    public modifierfilm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton8.setText("Modifier Film");
        ...
        jLabel1.setText("Modification Film");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        String idfilm=this.jTextField5.getText();
        String titre=this.jTextField8.getText();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,"Filim modifié avec succées");
        }
        catch(Exception e){
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modifierfilm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                modifierfilm a = new modifierfilm();
                a.setVisible(true);
