 ...
 * @author MSI
 */
public class ajoutticket extends javax.swing.JFrame {

    /**
     * Creates new form ajoutticket
     */
    public ajoutticket() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton8.setText("Enregistrer Ticket");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        String idClient=this.jTextField5.getText();
        String idfilm=this.jTextField6.getText();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,"Ticket ajouté avec succées");
        }
        catch(Exception e){
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ajoutticket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
