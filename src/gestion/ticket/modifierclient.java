...
public class modifierclient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("Modifier Client");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        String Nomp=this.jTextField8.getText();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,"Client(e) modifié(e) avec succées");
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                modifierclient a = new modifierclient();
                a.setVisible(true);
